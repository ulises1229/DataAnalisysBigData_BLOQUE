...
| Sesión 4    | Análisis Exploratorio de Datos con Dask         | <ul><li>Introducción a Dask</li><li>Carga y Manipulación de Datos a Gran Escala</li><li>Análisis Exploratorio de Datos (EDA) con Dask</li><li>Visualización de Datos a Gran Escala</li></ul>                                                               | ["Dask: Parallel Computing with Python" por Matthew Rocklin](https://docs.dask.org/en/latest/)                                             |             <ul><li> [Código día 4](code/BigData_BLOQUE_Sesión_4.ipynb) </li> <li> [Demo](/demos/demo-dia-4.ipynb) </li></ul>               |            [Sesión 4](/pdf/Sesión4.pdf)                 |
